...
angular.module('greencity.common.directives', [])
    ...
    return {
        ...
        link: function (scope, element, attrs) {
            ...
            scope.$on("toggle-type", function (event, show) {
                var password_input = element[0], input_type = password_input.getAttribute('type');
                if (!show) {
    ...
    return {
        ...
        link: function (scope, element, attr, ctrls) {
            ...
            $timeout(function () {
                var $itemOptions = itemCtrl.$element[0].getElementsByClassName("item-options"), $itemContent = itemCtrl.$element[0].getElementsByClassName("item-content"), options_width = $itemOptions[0].offsetWidth || 0;
